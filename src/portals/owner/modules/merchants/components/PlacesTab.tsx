...
export default function PlacesTab({ categories: initialCategories, preSelectedCategory }: PlacesTabProps) {
        ...
        <div className="shrink-0 p-2.5 sm:p-3 border-b border-slate-200 bg-slate-50 space-y-2.5 shadow-2xs">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-0.5 scrollbar-thin">
            <button
              ...
              className={`px-2.5 py-0.5 rounded-full text-xs font-bold border transition shrink-0 ${
